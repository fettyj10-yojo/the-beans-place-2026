...
export default function NavBar() {
    const [menuOpen, setMenuOpen] = useState(false);
    //container = menuOpen, function to update the container = setManuOpen,
    //current value= false
    const [scrolled, setScrolled] = useState(false);
        ...
        <motion.header
            ...
            <div className="mx-auto flex w-full max-w-7x1 items-center justify-between px-4 py-3 md:px-8">
                ...
                <button
                    ...
                    className="relative z-50 flex h-10 flex-col items-center justify-center gap-1.5 md:hidden">
                    <span
