...
export default function HeroSection() {
    ...
    return (
        <>
            {/* LEFT TEXT */}
            <div className="hero-text-column" id="home">
                <motion.div
                ...
                <motion.p
                    ...
                    Farm-to-cup single-origin coffee beans, roasted fresh daily and shipped directly
                    to your door. Taste the difference with our premium selection of ethically
                    sourced beans
                </motion.p>
                ...
                <motion.div
                    ...
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    transition={{ duration: 0.6, delay: 1.01 }}>
                    <span>★★★★★ 4.9/5 from 2,400 + custromers</span>
            ...
            <div className="hero-art-container">
                ...
                <motion.div
                    ...
                    <span className="hero-floating-badge-lable">FROM</span>
                    <span className="hero-floating-badge-price">FROM $14.99</span>
